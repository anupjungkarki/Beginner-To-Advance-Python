...
# Define the functio with parameters a and b
# call the function with arguments 3 and 5
# Print the result
# You can call the functio with different values of parameters to get the sum of different numbers.
# For example, callin sum(10, 20) will return 30.
